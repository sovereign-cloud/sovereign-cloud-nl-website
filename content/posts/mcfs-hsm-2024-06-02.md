...
If you are interested in more deepdive into the HSM, click the following links for more information:
  - <a href="https://learn.microsoft.com/en-us/azure/key-vault/managed-hsm/mhsm-control-data#administrative-security-controls">admiistrative security controls that are in place in Azure Key Vault Managed HSM</a>; <br>
