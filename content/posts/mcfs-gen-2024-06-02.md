...
Microsoft prioritises the confidence of its customers by offering a comprehensive and secure cloud platform. All cloud services are built on top of the key principles: security, privacy and compliance, which is the foundation of all cloud services. But for certain sovereign customers, confidence is insufficient. Microsoft's investments to provide Sovereignty controls in the public cloud augment the industry-leading security, privacy, and compliance capabilities as follows:
