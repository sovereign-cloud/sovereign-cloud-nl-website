...
In July 2022, Microsoft introduced Microsoft Cloud for Sovereignty, a solution tailored for governments to deploy workloads in the Microsoft cloud while meeting their specific sovereignty, compliance, security, and policy needs. This innovation establishes software boundaries in the cloud, providing extra protection through hardware-based confidentiality and encryption controls. Microsoft Cloud for Sovereignty offers enhanced tools, guidance, and guardrails for public cloud adoption with appropriate sovereign controls, enabling more control while leveraging the capabilities of the Microsoft Cloud to the fullest. Embracing cloud computing while adhering to digital sovereignty requirements can be complex, varying significantly across organizations, industries, and regions.

Microsoft Cloud for Sovereignty is tailored to meet the sovereignty needs of government organizations. Microsoft Cloud for Sovereignty is customizable and adheres to evolving local policies and regulatory requirements around the handling of data. Governments can implement secure, consistent, and compliant environments and adhere to evolving local regulations while taking full advantage of the cloud. The benefits and value of running applications in the Azure public cloud are substantial. Features such as scalability, elasticity, resiliency, compliance, agility, and unmatched cybersecurity make it a compelling choice for businesses looking to optimize their operations and enhance security. With Azure public cloud, organizations can have scalability, elasticity, resiliency, compliance, agility, and cybersecurity, reaping the benefits of the cloud while meeting sovereignty and compliance demands.
...
Customers now have the ability to add an additional layer of protection for sensitive workloads, ensuring that operators (Cloud Provider) are unable to access customer data and resources. This enhanced security feature offers customers more control over their data sovereignty. The portfolio includes the following:<br>
...
<I>Sovereign control portfolio</I> <br>
Microsoft Cloud for Sovereignty offers access to codified architectures, workload templates, and tooling to facilitate compliant environments meeting sovereignty, privacy, and regulatory needs. Sovereign control portfolio builds on top of existing concepts and services like Infrastructure-as-Code, Azure Policy, and Policy-as-Code. The capabilities are:
...
The foundation of Microsoft Cloud for Sovereignty is Azure hyperscale public cloud, which delivers innovation, scale, and security significantly beyond private or on-premises data centers and protect against cyber-attacks. For more information, click <a href="https://learn.microsoft.com/en-us/industry/sovereignty/why-public-cloud">here</a>

<br>

<B>Microsoft's Trusted Cloud and Cloud for Sovereignty augmentation</B> <br>
Microsoft prioritises the confidence of its customers by offering a comprehensive and secure cloud platform. All cloud services are built on top of the key principles: security, privacy and compliance. Three fundamental concepts form the foundation of all cloud services: compliance, security, and privacy. But for certain sovereign customers, confidence is insufficient. Microsoft's investments to provide Sovereignty controls in the public cloud augment our industry-leading security, privacy, and compliance capabilities as follows:
