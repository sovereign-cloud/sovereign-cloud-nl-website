---
title: "Microsoft Confidential Compute Updates - Q4 2025" # Title of the blog post.
date: 2025-12-25T14:30:35+01:00 # Date of post creation.
description: "Microsoft Confidential Compute Updates Q4 2025." # Description used for search engine.
...
Within this blog, We want to give an overview of all the features that become available in General Availability and/or Technical Preview by Microsoft.
...
- [General Available] <a href="https://learn.microsoft.com/en-us/azure/developer/azure-mcp-server/tools/azure-confidential-ledger">Generally Availaible: Azure MCP Server support for Azure confidential ledger</a> <br>
...
- [General Available] <a href="https://techcommunity.microsoft.com/blog/azureconfidentialcomputingblog/azure-intel%C2%AE-tdx-confidential-vms-momentum/4470736">Azure Intel® TDX confidential VMs momentum</a> <br>
...
- [Private Preview] <a href="https://techcommunity.microsoft.com/blog/azureconfidentialcomputingblog/securing-confidential-vm-backups-with-azure-recovery-services-vault-and-private-/4458965">Securing Confidential VM Backups with Azure Recovery Services Vault and Private Endpoints</a> <br>

When working with Confidential VMs (CVMs) in Azure, ensuring secure backups is just as important as protecting workloads in use. Confidential VMs use hardware-based Trusted Execution Environments (TEEs) such as AMD SEV-SNP or Intel TDX to keep your data safe. But how do you securely back up this data without exposing it to the public internet? The answer lies in combining Azure Recovery Services Vault (RSV) with Private Endpoints. <br>
- [Public Preview] <a href="https://learn.microsoft.com/en-us/azure/postgresql/overview#azure-regions">Public Preview: Azure Database for PostgreSQL – Flexible Server v6 series VMs and AMD v6 Confidential Compute</a> <br>
...
- [ Public Preview] <a href="https://learn.microsoft.com/en-us/azure/container-apps/security##confidential-compute-preview">Confidential computing in Azure Container Apps</a> <br>
...
- [ Private Preview] <a href="https://techcommunity.microsoft.com/blog/azureinfrastructureblog/powering-modern-cloud-workloads-with-azure-boost-ignite-2025/4470793">Private Preview: Azure Boost confidential device</a> <br>
